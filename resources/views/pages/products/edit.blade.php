        ...
        <div class="card-body">
            <div class="card-block">
                <form action="{{route('products.update', $item->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="quatity" class="form-control-label">Banyak Barang</label>
                        <input type="number" name="quatity" value="{{ old('quatity') ? old('quatity') : $item->quatity }}" class="form-control @error('quatity') is-invalid @enderror"/>
                        @error('quatity') <div class="text-muted">{{ $message }}</div> @enderror
                    </div>
